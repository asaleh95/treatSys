    ...
    sendImage(e) {
      ...
      for (let index = 0; index < images.length; index++) {
        ...
        reader.onload = (e) => {
          ...
          this.lab.images.push(e.target.result);
        };
      }
    },
    sendLogo(e) {
      ...
      reader.onload = (e) => {
        ...
        this.lab.logo = this.previewLogo;
    ...
    submit() {
      axios
        ...
        .then((result) => {
          ...
          //
          this.success = true;
          setTimeout(() => this.$router.push("/laps/all"), 2000);
        })
        .catch(
