        ...
        >
          <div class="row">
            <div class="col-lg-6 col-12 mb-30">
              ...
              <input class="form-control" type="text" v-model="pharm.name" placeholder="آسم الصيدليه " />
            ...
            <div class="col-lg-6 col-12 mb-30">
              ...
              <input class="form-control" type="number" v-model="pharm.phone" placeholder="رقم الهاتف" />
              <div class="animated bounce infinite rtl">
            ...
            <div class="col-lg-6 col-12 mb-30">
              ...
              <input class="form-control" type="text" v-model="pharm.address" placeholder="العنوان" />
              <div class="animated bounce infinite rtl">
            ...
            <div class="col-lg-6 col-12 mb-30">
              ...
              <input class="form-control" type="text" v-model="pharm.location" placeholder="الاحداثيات" />
              <div class="animated bounce infinite rtl">
            ...
            <div class="col-lg-6 col-12 mb-30">
              ...
              <input class="form-control" type="text" v-model="pharm.position" placeholder="الوظيفه" />
              <div class="animated bounce infinite rtl">
            ...
            <div class="col-lg-6 col-12 mb-30">
              ...
              <input class="form-control" type="number" v-model="pharm.rate" placeholder="التقييم" />
              <div class="animated bounce infinite rtl">
            ...
            <div class="col-lg-6 col-12 mb-30">
              ...
              <input class="form-control" type="number" v-model="pharm.basic_price" placeholder="السعر الاولى" />
              <div class="animated bounce infinite rtl">
            ...
            <div class="col-lg-6 col-12 mb-30">
              ...
              <input class="form-control" type="number" v-model="pharm.treat_price" placeholder="سعر التعامل" />
              <div class="animated bounce infinite rtl">
            ...
            <div class="col-12 mb-30">
              ...
              <textarea class="form-control" v-model="pharm.about" placeholder=" الملاحظات"></textarea>
              <div class="animated bounce infinite rtl">
  ...
  mounted() {
    axios
      ...
      .then((result) => {
        ...
        this.pharm.location = result.data.data.location.coordinates[0] + ',' + result.data.data.location.coordinates[1];
  ...
  methods: {
    sendImage(e) {
      ...
      reader.onload = (e) => {
        ...
        this.pharm.image = this.previewImage;
    ...
    submit() {
      axios
        .put("/admins/pharmcies/" + this.pharm.id, this.pharm)
        .then((result) => {
          console.log(result.data);
          //
          this.success = true
          setTimeout(() => this.$router.push("/pharmcies/all"), 2000);
        })
        .catch(
