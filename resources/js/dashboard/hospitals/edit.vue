        ...
        >
          <div class="row">
            <div class="col-lg-6 col-12 mb-30">
              ...
              <input class="form-control" type="text" v-model="hospital.name" placeholder="آسم المستشفي " />
            ...
            <div class="col-lg-6 col-12 mb-30">
              ...
              <input class="form-control" type="number" v-model="hospital.phone" placeholder="رقم الهاتف" />
              <div class="animated bounce infinite rtl">
            ...
            <div class="col-lg-6 col-12 mb-30">
              ...
              <input class="form-control" type="text" v-model="hospital.address" placeholder="العنوان" />
              <div class="animated bounce infinite rtl">
            ...
            <div class="col-lg-6 col-12 mb-30">
              ...
              <input class="form-control" type="text" v-model="hospital.location" placeholder="الاحداثيات" />
              <div class="animated bounce infinite rtl">
            ...
            <div class="col-lg-6 col-12 mb-30">
              ...
              <input class="form-control" type="text" v-model="hospital.position" placeholder="الوظيفه" />
              <div class="animated bounce infinite rtl">
            ...
            <div class="col-lg-6 col-12 mb-30">
              ...
              <input class="form-control" type="number" v-model="hospital.rate" placeholder="التقييم" />
              <div class="animated bounce infinite rtl">
            ...
            <div class="col-lg-6 col-12 mb-30">
              ...
              <input class="form-control" type="number" v-model="hospital.basic_price" placeholder="السعر الاولى" />
              <div class="animated bounce infinite rtl">
            ...
            <div class="col-lg-6 col-12 mb-30">
              ...
              <input class="form-control" type="number" v-model="hospital.treat_price" placeholder="سعر التعامل" />
              <div class="animated bounce infinite rtl">
            ...
            <div class="col-12 mb-30">
              ...
              <textarea class="form-control" v-model="hospital.about" placeholder=" الملاحظات"></textarea>
              <div class="animated bounce infinite rtl">
  ...
  mounted() {
    axios
      ...
      .then((result) => {
        ...
        this.hospital.location = result.data.data.location.coordinates[0] + ',' + result.data.data.location.coordinates[1];
  ...
  methods: {
    sendImage(e) {
      ...
      reader.onload = (e) => {
        ...
        this.hospital.image = this.previewImage;
